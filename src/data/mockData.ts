...
export const tariffsData: Tariff[] = [
  ...
  },
  {
    ...
    perKm: '4 500',
    freeWait: '10 daqiqa',
    description: 'Muhim biznes uchrashuvlar va tantanali tadbirlar uchun elita qatnov.',
    cars: 'Malibu 2, BYD Han, Kia K5',
    features: [
      '4 500 so\'m / km',
      'Ichimlik suvi & telefon zaryadlagich',
  ...
  },
  {
    ...
    perKm: '2 000',
    freeWait: '5 daqiqa',
    description: 'Muhim hujjatlar va posilkalarni kafolatli eshikkacha yetkazish.',
    cars: 'Tezkor shahar kuryerlari',
    features: [
      '2 000 so\'m / km',
      'Xaritada jonli kuzatuv',
